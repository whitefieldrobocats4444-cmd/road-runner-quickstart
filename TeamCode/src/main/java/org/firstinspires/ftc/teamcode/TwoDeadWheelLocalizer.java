...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -1705.607019134822; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -1697.4911384504683; // x position of the perpendicular encoder (in tick units)
    }
